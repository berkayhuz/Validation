...
public static partial class RuleBuilderExtensions
{
        ...
        this IRuleBuilder<T, IFormFile> ruleBuilder, long maxSizeInMb, string[] allowedExtensions, string[] allowedContentTypes)
        => ruleBuilder.SetValidator(new FileValidator<T>(maxSizeInMb * 1024 * 1024,
                allowedExtensions,
                allowedContentTypes));
        ...
        this IRuleBuilder<T, string> ruleBuilder, string prefix, bool caseSensitive = false)
        ...
        this IRuleBuilder<T, string> ruleBuilder, string suffix, bool caseSensitive = false)
        ...
        this IRuleBuilder<T, string> ruleBuilder, string pattern, RegexOptions options = RegexOptions.None)
        ...
        this IRuleBuilder<T, string> ruleBuilder, string dependentProperty, string requiredWhenValue)
        ...
        this IRuleBuilder<T, IComparable> ruleBuilder, Func<T, IComparable> otherSelector, Func<IComparable, IComparable, bool> comparer)
